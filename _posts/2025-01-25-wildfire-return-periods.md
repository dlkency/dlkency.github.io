...
<strong>This is the first key insight:</strong> Burned area is not risk. Exposure is.
</div>
...
- Recent Los Angeles–area fires generated some of the largest wildfire losses globally, with insured losses estimated by Swiss Re near 40 Billion dollars and total economic losses esimtated by AccuWeather at $250–275 Billion.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/wildfire_risk.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
   LA Fire 2025.
...
<div style="background:#fff3b0; padding:10px; border-radius:6px">
Wildfire risk is no longer about hectares burned.

It is about rare alignments of fire, weather, development, and asset value that produce losses capable of reshaping insurance markets and undermining community resilience.

Until wildfire models can estimate the return periods of destructive losses, we will continue to underestimate risk in exactly the places that matter most. Stay tuned on my research of wildfire return period. 
</div>
